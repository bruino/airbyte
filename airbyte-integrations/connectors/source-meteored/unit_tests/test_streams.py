...
import pytest
from source_meteored.source import MeteoredStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MeteoredStream, "path", "v0/example_endpoint")
    mocker.patch.object(MeteoredStream, "primary_key", "test_primary_key")
    mocker.patch.object(MeteoredStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MeteoredStream()
